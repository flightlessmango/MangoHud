...
DEPS_DEBIAN="gcc,g++,gcc-multilib,g++-multilib,ninja-build,meson,python3-mako,python3-pip,python3-setuptools,python3-wheel,pkg-config,glslang-tools,mesa-common-dev,libgl-dev,libgl-dev:i386,libegl-dev,libegl-dev:i386,libvulkan-dev,libvulkan-dev:i386,libx11-dev,libxnvctrl-dev,libdbus-1-dev,libsystemd-dev,libsystemd-dev:i386,libdrm-dev,libcap-dev,libyaml-cpp-dev,python3-numpy,python3-matplotlib,libxkbcommon-dev,libxkbcommon-dev:i386,libwayland-dev,libwayland-dev:i386,libwayland-egl-backend-dev,wayland-protocols,libgbm-dev,unzip,wget"
