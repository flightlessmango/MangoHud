...
DEPS_DEBIAN="gcc,g++,gcc-multilib,g++-multilib,ninja-build,meson,python3-mako,python3-setuptools,python3-wheel,pkg-config,mesa-common-dev,libx11-dev,libxnvctrl-dev,libdbus-1-dev,python3-numpy,python3-matplotlib,libxkbcommon-dev,libxkbcommon-dev:i386,libwayland-dev,libwayland-dev:i386,libvulkan-dev,libvulkan-dev:i386,libyaml-cpp-dev,libsystemd-dev,libsystemd-dev:i386,libcap-dev,libegl1-mesa-dev,libegl1-mesa-dev:i386,libgbm-dev,libgbm-dev:i386,mesa-common-dev:i386,glslang-tools,appstream"
